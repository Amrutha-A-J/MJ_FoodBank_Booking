  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (apiErr?.status === 401) {
        ...
        setError("You don’t have an account in our system. Please email harvestpantry@mjfoodbank.org with your full name to create an account.");
      } else {
      ...
      <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" minHeight="80vh" px={2}>
        ...
        >
          <TextField
            ...
            helperText={identifierError ? "Client ID or email is required" : ''}
            autoFocus
