...
- Volunteers can view their ranking via `GET /volunteer-stats/leaderboard`, which returns `{ rank, percentile }`. The volunteer dashboard displays "You're in the top X%" using this data without revealing other volunteers' information.
