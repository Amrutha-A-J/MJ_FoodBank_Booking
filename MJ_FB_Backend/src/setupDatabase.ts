...
export async function setupDatabase() {
  ...
  if (tableCheck.rows[0].table_exists) {
    ...
    await client.query(`
      ...
      CREATE TABLE IF NOT EXISTS monetary_donors (
        id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
        name text NOT NULL UNIQUE,
        email text,
        phone text
      );
      CREATE TABLE IF NOT EXISTS monetary_donation_log (
        id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
        donor_id integer NOT NULL REFERENCES public.monetary_donors(id),
