...
INSERT INTO volunteer_roles (id, name, max_volunteers, category_id) VALUES
(1, 'Food Sorter', 3, 2),
(2, 'Production Worker', 3, 2),
(3, 'Driver Assistant', 1, 2),
(4, 'Loading Dock Personnel', 1, 2),
(5, 'General Cleaning & Maintenance', 1, 2),
(6, 'Reception', 1, 1),
(7, 'Greeter / Pantry Assistant', 3, 1),
(8, 'Stock Person', 1, 1),
(9, 'Gardening Assistant', 2, 3),
(10, 'Event Organizer', 5, 5),
(11, 'Event Resource Specialist', 5, 5),
(12, 'Volunteer Marketing Associate', 1, 4),
(13, 'Client Resource Associate', 1, 4),
(14, 'Assistant Volunteer Coordinator', 1, 4),
(15, 'Volunteer Office Administrator', 1, 4)
ON CONFLICT (id) DO NOTHING;

INSERT INTO volunteer_slots (role_id, start_time, end_time, is_wednesday_slot) VALUES
(1, '09:00:00', '12:00:00', false),
(2, '09:00:00', '12:00:00', false),
(3, '09:00:00', '12:00:00', false),
(4, '09:00:00', '12:00:00', false),
(5, '08:00:00', '11:00:00', false),
(6, '09:00:00', '12:00:00', false),
(6, '12:30:00', '15:30:00', false),
(6, '15:30:00', '18:30:00', true),
(7, '09:00:00', '12:00:00', false),
(7, '12:30:00', '15:30:00', false),
(7, '15:30:00', '18:30:00', true),
(7, '16:30:00', '19:30:00', true),
(8, '08:00:00', '11:00:00', false),
(8, '12:00:00', '15:00:00', false),
(9, '13:00:00', '16:00:00', false),
(10, '09:00:00', '17:00:00', false),
(11, '09:00:00', '17:00:00', false),
(12, '08:00:00', '16:00:00', false),
(13, '08:00:00', '16:00:00', false),
(14, '08:00:00', '16:00:00', false),
(15, '08:00:00', '16:00:00', false)
