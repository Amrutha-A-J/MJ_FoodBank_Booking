...
`);
  ...
  await client.query(`
    ALTER TABLE volunteer_master_roles ADD COLUMN IF NOT EXISTS is_active boolean DEFAULT true;
...
INSERT INTO volunteer_master_roles (id, name, is_active) VALUES
(1, 'Pantry', true),
(2, 'Warehouse', true),
(3, 'Gardening', true),
(4, 'Administration', true),
(5, 'Special Events', true)
ON CONFLICT DO NOTHING;

INSERT INTO volunteer_roles (start_time, end_time, max_volunteers, category_id, is_wednesday_slot) VALUES
('09:00:00', '12:00:00', 3, 2, false),
('09:00:00', '12:00:00', 3, 2, false),
('09:00:00', '12:00:00', 1, 2, false),
('09:00:00', '12:00:00', 1, 2, false),
('08:00:00', '11:00:00', 1, 2, false),
('09:30:00', '12:30:00', 1, 1, false),
('12:30:00', '15:30:00', 1, 1, false),
('15:30:00', '18:30:00', 1, 1, true),
('09:00:00', '12:00:00', 3, 1, false),
('12:30:00', '15:30:00', 3, 1, false),
('15:30:00', '18:30:00', 2, 1, true),
('16:30:00', '19:30:00', 2, 1, true),
('08:00:00', '11:00:00', 1, 1, false),
('12:00:00', '15:00:00', 1, 1, false),
('13:00:00', '16:00:00', 2, 3, false),
('09:00:00', '17:00:00', 5, 5, false),
('09:00:00', '17:00:00', 5, 5, false),
('08:00:00', '16:00:00', 1, 4, false),
('08:00:00', '16:00:00', 1, 4, false),
('08:00:00', '16:00:00', 1, 4, false),
('08:00:00', '16:00:00', 1, 4, false)
ON CONFLICT DO NOTHING;
