...
`DONOR_TEMPLATE_ID_1_100` – Brevo template ID for donors contributing $1–$100 (default 11).

`DONOR_TEMPLATE_ID_101_500` – Brevo template ID for donors contributing $101–$500 (default 12).

`DONOR_TEMPLATE_ID_501_PLUS` – Brevo template ID for donors contributing $501+ (default 12).
