    ...
    (pool.query as jest.Mock)
      ...
      .mockResolvedValueOnce({
        rows: [
          ...
          { id: 4, firstName: 'D', lastName: 'D', email: 'd@example.com', amount: 2000 },
          { id: 5, firstName: 'E', lastName: 'E', email: 'e@example.com', amount: 15000 },
        ],
      });
    ...
    (pool.query as jest.Mock)
      ...
      .mockResolvedValueOnce({
        rows: [
          ...
          { first_name: 'D', email: 'd@example.com', amount: 2000 },
          { first_name: 'E', email: 'e@example.com', amount: 15000 },
        ],
        rowCount: 5,
      })
      .mockResolvedValueOnce({
