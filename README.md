...
- Refresh tokens stay valid for up to 365 days by default so users remain signed in until they explicitly log out. Adjust `REFRESH_TOKEN_TTL_DAYS` in the backend environment to shorten or extend this window for your deployment.
