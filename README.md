...
- Volunteers can view their rank and percentile through `GET /volunteer-stats/leaderboard`; the dashboard shows "You're in the top X%" without revealing other volunteers.
