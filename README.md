...
- Admins can manage volunteer master roles, sub-roles, and their shifts from the Volunteer Settings page. The page includes separate dialogs for creating new sub-roles with an initial shift and for adding or editing shifts in existing sub-roles. Deleting a master role also removes its sub-roles and shifts.
